...
The backend CORS default supports local browser access from `http://127.0.0.1:1420` and `http://localhost:1420`. Packaged Tauri origins are no longer part of the default local or release workflow.
