...
def test_all_implemented_phase2_models_have_runnable_adapters() -> None:
    implemented = [m for m in PHASE2_MODEL_METADATA if m.implemented]
...
def test_phase2_adapter_capabilities_resolve_task_heads() -> None:
    for metadata in PHASE2_MODEL_METADATA:
...
def test_phase2_model_metadata_declares_capabilities() -> None:
    for metadata in PHASE2_MODEL_METADATA:
